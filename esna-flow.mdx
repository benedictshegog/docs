...
| `metering_point_grid_identifier` | No | Official MPAN |
| `measurement_granularity` | Yes | Data resolution (e.g., `PT30M`) |
| `BMUnitIdentifier` | Yes | BMU identifier (e.g., `2__A_SITE_001`) |

<Note>
The `BMUnitIdentifier` column is **required** for ESNA submissions. It must follow the format `2__X...` where `X` is a GSP Group ID (A-P).
</Note>
...
CUST_001,Acme Corp,GB,MPAN_001,1234567890123,PT30M,2__A_ACME_001
CUST_001,Acme Corp,GB,MPAN_002,1234567890124,PT30M,2__A_ACME_002
CUST_002,Beta Ltd,GB,MPAN_003,1234567890125,PT30M,2__B_BETA_001
```
...
| `metering_point_reference` | Yes | Your unique identifier for the meter |
| `metering_point_grid_identifier` | No | Official MPAN |
| `production_device_bm_unit_identifier` | No | BMU identifier for the generator |
...
SOLAR_001,Solar Farm Alpha,GB,SOLAR,METER_001,9876543210123,2__A_SOLAR_001
WIND_001,Wind Farm Beta,GB,WIND,METER_002,9876543210124,2__G_WIND_001
```
